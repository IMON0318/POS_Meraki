          ...
          <div class="col-md-12">
            <div class="card card-success card-outline">
              ...
              <tr>
                   ...
                   <td>
                      <a href="#" class="btn btn-block bg-dark"><h4>Client Information</h4></a>
                    </td>
                     <td>
                      <button type="submit" name="add_user" class="btn btn-block bg-orange">Add Client</button>
                    </td>
                    <!-- <td>
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input style="display: none;" type="number" class="form-control" id="role" name="role" value="2">
                </div><!-- end of col-sm-4 -->
